...
def build_vocab(imgs, params):
    ...
    vocab = counter.most_common(2000)
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/root/PycharmProjects/dataset_rsicd/dataset_rsicd.json', help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='/root/PycharmProjects/dataset_rsicd/rsicd.json', help='output json file')
    parser.add_argument('--output_h5', default='/root/PycharmProjects/dataset_rsicd/data', help='output h5 file')
